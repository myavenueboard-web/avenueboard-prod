...
function getPerksSection(value: string | null): PerksSection {
  return value === "credit-building" ? "credit-building" : "avenue-perks";
}
  ...
  return (
    <main className="flex min-h-screen flex-col bg-white font-sans text-[#0F172A]">
      ...
      {activeSection === "credit-building" ? (
        ...
        <AvenuePerksSection locked={locked} />
      )}
...
function AvenuePerksSection({ locked }: { locked: boolean }) {
  return (
    <>
      ...
      <section className="relative mx-auto w-full max-w-[1600px] flex-1 px-5 pb-14 pt-9 sm:px-7 lg:px-16">
        ...
        {locked && (
          <LockedBenefitOverlay learnMoreHref="/latest-landing#avenue-perks" />
        )}
      </section>
    </>
  );
...
function CreditBuildingSection({ locked }: { locked: boolean }) {
  return (
    <section className="relative mx-auto w-full max-w-[1680px] flex-1 px-6 py-20">
      ...
      {locked && (
        <div className="absolute inset-0 z-10 flex items-center justify-center bg-white/25 px-4">
          <LockedBenefitCard learnMoreHref="/latest-landing#credit-building" />
        </div>
      )}
    </section>
  );
...
function LockedBenefitOverlay({ learnMoreHref }: { learnMoreHref: string }) {
  return (
    <div className="absolute inset-0 z-10 flex items-start justify-center bg-white/25 px-4 pt-24">
      <LockedBenefitCard learnMoreHref={learnMoreHref} />
    </div>
  );
}

function LockedBenefitCard({ learnMoreHref }: { learnMoreHref: string }) {
  return (
